...
namespace ModernUI.Toolkit.Data.Charting.Charts.DataPoints
{
    ...
    public abstract partial class DataPoint : Control
    {
        ...
        /// </summary>
        internal event PropertChangedEventHander<bool> IsSelectedChanged;
        ...
        protected virtual void OnIsHoveredPropertyChanged(bool oldValue, bool newValue)
        {
            if (newValue)
            {
                VisualStateManager.GoToState(this, StateCommonMouseOver,true);
            }
            else
            {
                VisualStateManager.GoToState(this, StateCommonNormal, true);
            }
        ...
        protected virtual void OnIsSelectedPropertyChanged(bool oldValue, bool newValue)
        {
            ...
            PropertChangedEventHander<bool> handler = this.IsSelectedChanged;
            if (handler != null)
            {
        ...
        /// </summary>
        internal event PropertChangedEventHander<double> ActualDependentValueChanged;

        #region public double ActualDependentValue
        /// <summary>
        /// Gets or sets the actual dependent value displayed in the chart.
        /// </summary>
        public double ActualDependentValue
        {
            get { return (double)GetValue(ActualDependentValueProperty); }
        ...
        /// </summary>
        private double _oldActualDependentValueBeforeCoercion;
        ...
        /// <param name="oldValue">The value to be replaced.</param>
        /// <param name="newValue">The new value.</param>
        protected virtual void OnActualDependentValuePropertyChanged(double oldValue, double newValue)
        {
            ...
            if (!_isCoercingActualDependentValue)
            {
                if (_oldActualDependentValueBeforeCoercion != null)
                {
                    ...
                    _oldActualDependentValueBeforeCoercion = 0.0;
                }

                PropertChangedEventHander<double> handler = this.ActualDependentValueChanged;
                if (handler != null)
                {
                    handler(this,oldValue, newValue);
                }
        ...
        /// changed.
        /// </summary>
        internal event PropertChangedEventHander<double> DependentValueChanged;
        ...
        {
            get { return (double)GetValue(DependentValueProperty); }
        ...
        /// <param name="oldValue">The value to be replaced.</param>
        /// <param name="newValue">The new value.</param>
        protected virtual void OnDependentValuePropertyChanged(double oldValue, double newValue)
        {
            SetFormattedProperty(FormattedDependentValueProperty, DependentValueStringFormat, newValue);
            PropertChangedEventHander<double> handler = this.DependentValueChanged;
            if (handler != null)
            {
                handler(this,oldValue, newValue);
            }
        ...
        /// </summary>
        internal event PropertChangedEventHander<object> IndependentValueChanged;
        ...
        protected virtual void OnIndependentValuePropertyChanged(object oldValue, object newValue)
        {
            ...
            PropertChangedEventHander<object> handler = this.IndependentValueChanged;
            if (handler != null)
            {
                handler(this,oldValue, newValue);
            }
        ...
        /// changed.
        /// </summary>
        internal event PropertChangedEventHander<object> ActualIndependentValueChanged;
        ...
        protected virtual void OnActualIndependentValuePropertyChanged(object oldValue, object newValue)
        {
            ...
            if (!_isCoercingActualIndependentValue)
            {
                ...
                PropertChangedEventHander<object> handler = this.ActualIndependentValueChanged;
                if (handler != null)
                {
                    handler(this,oldValue, newValue);
                }
        ...
        /// </summary>
        internal event PropertChangedEventHander<DataPointState> StateChanged;
        ...
        protected virtual void OnStatePropertyChanged(DataPointState oldValue, DataPointState newValue)
        {
            if (!IsCoercingState)
            {
                ...
                else
                {
                    ...
                    // Fire Changed event
                    PropertChangedEventHander<DataPointState> handler = this.StateChanged;
                    if (handler != null)
                    {
                        handler(this,oldValue, newValue);
                    }
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (null != groupReveal)
            {
                groupReveal.CurrentStateChanged -= groupReveal_CurrentStateChanged;
            }
