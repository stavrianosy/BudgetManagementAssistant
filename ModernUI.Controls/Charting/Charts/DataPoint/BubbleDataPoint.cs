...
namespace ModernUI.Toolkit.Data.Charting.Charts.DataPoints
{
    ...
    public class BubbleDataPoint : DataPoint
    {
        ...
        {
            PropertChangedEventHander<double> handler = SizePropertyChanged;
            if (handler != null)
            {
        ...
        /// </summary>
        internal event PropertChangedEventHander<double> SizePropertyChanged;
        ...
        {
            PropertChangedEventHander<double> handler = ActualSizePropertyChanged;
            if (handler != null)
            {
                handler(this, oldValue, newValue);
            }
        ...
        /// </summary>
        internal event PropertChangedEventHander<double> ActualSizePropertyChanged;
