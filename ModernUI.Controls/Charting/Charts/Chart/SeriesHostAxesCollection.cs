...
namespace ModernUI.Toolkit.Data.Charting.Charts.Chart
{
    ...
    internal class SeriesHostAxesCollection : UniqueObservableCollection<IAxis>
    {
        ...
        protected override void RemoveItem(int index)
        {
            ...
            {
                throw new InvalidOperationException(ModernUI.Toolkit.Data.Charting.Resources.SeriesHostAxesCollection_RemoveItem_AxisCannotBeRemovedFromASeriesHostWhenOneOrMoreSeriesAreListeningToIt);
            }
            else if (PersistentAxes.Contains(axis))
            {
                throw new InvalidOperationException(ModernUI.Toolkit.Data.Charting.Resources.SeriesHostAxesCollection_InvalidAttemptToRemovePermanentAxisFromSeriesHost);
            }
            else
            {
