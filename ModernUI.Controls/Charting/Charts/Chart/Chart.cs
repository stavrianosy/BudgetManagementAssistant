...
using ModernUI.Toolkit.Data.Charting;
using ModernUI.Toolkit.Data.Charting.Charts;
...
using ModernUI.Toolkit.Data.Charting.Legends;
using System;
...
namespace ModernUI.Toolkit.Data.Charting.Charts.Chart
{
    /// <summary>
    ...
    public partial class Chart : Control, ISeriesHost
    {
        ...
        public Collection<IAxis> Axes
        {
            ...
            set
            {
                throw new NotSupportedException(ModernUI.Toolkit.Data.Charting.Resources.Chart_Axes_SetterNotSupported);
            }
        }
        ...
        /// </summary>
        private ObservableCollection<Axis.Axis> _edgeAxes = new NoResetObservableCollection<Axis.Axis>();
        ...
        public Collection<ISeries> Series
        {
            ...
            set
            {
                throw new NotSupportedException(ModernUI.Toolkit.Data.Charting.Resources.Chart_Series_SetterNotSupported);
            }
        }
        ...
        void axis_OrintationChanged(object sender, AxisOrientation e)
        {
        ...
        private void ActualAxesCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                foreach (Axis.Axis axis in e.NewItems.OfType<Axis.Axis>())
                {
            ...
            if (e.OldItems != null)
            {
                foreach (Axis.Axis axis in e.OldItems.OfType<Axis.Axis>())
                {
