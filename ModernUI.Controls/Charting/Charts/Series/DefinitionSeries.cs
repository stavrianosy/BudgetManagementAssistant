...
using ModernUI.Toolkit.Data.Charting.Charts.Primitives;
using System;
...
namespace ModernUI.Toolkit.Data.Charting.Charts.Series
{
    ...
    public abstract class DefinitionSeries : Control, ISeries, IAxisListener, IRangeProvider, IValueMarginProvider, IDataProvider, ISeriesHost
    {
        ...
        public Collection<SeriesDefinition> SeriesDefinitions
        {
            ...
            set { throw new NotSupportedException(ModernUI.Toolkit.Data.Charting.Resources.DefinitionSeries_SeriesDefinitions_SetterNotSupported); }
        }
        ...
        private void PrepareContainerForItem(DependencyObject element, object item)
        {
            ...
            dataPoint.DependentValueChanged += dataPointDependentValueChanged;
            dataPoint.ActualDependentValueChanged += DataPointActualDependentValueChanged;
            dataPoint.IndependentValueChanged += DataPointIndependentValueChanged;
            dataPoint.ActualIndependentValueChanged += DataPointActualIndependentValueChanged;
            dataPoint.StateChanged += DataPointStateChanged;
        ...
        void dataPointDependentValueChanged(object sender, double OldValue, double NewValue)
        {
            ...
            {
                dataPoint.BeginAnimation(DataPoint.ActualDependentValueProperty, "ActualDependentValue", NewValue, definition.TransitionDuration);
            }
            else
            {
        ...
        /// <param name="sender">Event source.</param>
        /// <param name="e">Event arguments.</param>
        private void DataPointDependentValueChanged(object sender, IComparable e)
        {
        ...
        /// <param name="sender">Event source.</param>
        /// <param name="e">Event arguments.</param>
        private void DataPointActualDependentValueChanged(object sender,double oldValue,double newValue)
        {
            DataPoint dataPoint = (DataPoint)sender;
        ...
        /// <param name="sender">Event source.</param>
        /// <param name="e">Event arguments.</param>
        private void DataPointIndependentValueChanged(object sender, object oldValue,object newValue)
        {
            DataPoint dataPoint = (DataPoint)sender;
            SeriesDefinition definition = DataItemFromDataPoint(dataPoint).SeriesDefinition;
            TimeSpan transitionDuration = definition.TransitionDuration;
        ...
        /// <param name="sender">Event source.</param>
        /// <param name="e">Event arguments.</param>
        private void DataPointActualIndependentValueChanged(object sender, object oldValue,object newValue)
        {
            DataPoint dataPoint = (DataPoint)sender;
        ...
        /// <param name="sender">Event source.</param>
        /// <param name="e">Event arguments.</param>
        private void DataPointStateChanged(object sender, DataPointState oldValue,DataPointState newValue)
        {
            DataPoint dataPoint = (DataPoint)sender;
        ...
        private void EnsureAxes(bool updateDependentAxis, bool updateIndependentAxis, bool unconditionallyNotifyAxes)
        {
            foreach (SeriesDefinition definition in SeriesDefinitions)
            {
                ...
                {
                    throw new InvalidOperationException(ModernUI.Toolkit.Data.Charting.Resources.DefinitionSeries_EnsureAxes_MissingDependentValueBinding);
                }
                if (null == definition.IndependentValueBinding)
                {
                    throw new InvalidOperationException(ModernUI.Toolkit.Data.Charting.Resources.DefinitionSeries_EnsureAxes_MissingIndependentValueBinding);
                }
            }
