...
namespace ModernUI.Toolkit.Data.Charting.Charts.Series
{
    ...
    public abstract class DataPointSeriesWithAxes : DataPointSeries, IDataProvider, IRangeProvider, IAxisListener, IValueMarginProvider
    {
        ...
        protected override void OnDataPointActualDependentValueChanged(object sender, double oldValue, double newValue)
        {
        ...
        /// <param name="oldValue">The old value.</param>
        /// <param name="newValue">The new value.</param>
        protected override void OnDataPointDependentValueChanged(object dataPoint, double oldValue, double newValue)
        {
            DataPoint sender = (DataPoint)dataPoint;
            if ((null != InternalActualDependentAxis))
            {
                
                 sender.BeginAnimation(DataPoint.ActualDependentValueProperty, "ActualDependentValue", newValue, this.TransitionDuration);
            }
            else
            {
        ...
        /// <param name="oldValue">The old value.</param>
        /// <param name="newValue">The new value.</param>
        protected override void OnDataPointActualIndependentValueChanged(object sender, object oldValue, object newValue)
        {
            DataPoint dataPoint = (DataPoint)sender;
        ...
        /// <param name="oldValue">The old value.</param>
        /// <param name="newValue">The new value.</param>
        protected override void OnDataPointIndependentValueChanged(object sender, object oldValue, object newValue)
        {
            DataPoint dataPoint = (DataPoint)sender;
