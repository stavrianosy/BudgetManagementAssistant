...
namespace ModernUI.Toolkit.Data.Charting.Charts.Axis
{
    ...
    public abstract class DisplayAxis : Axis, IRequireSeriesHost
    {
        ...
        protected long ActualLength
        {
            get
            {
                return (long)GetLength(new Size(this.ActualWidth, this.ActualHeight));
            }
        }
        ...
        protected double GetLength(Size availableSize)
        {
            ...
            {
                throw new InvalidOperationException(ModernUI.Toolkit.Data.Charting.Resources.DisplayAxis_GetLength_CannotDetermineTheLengthOfAnAxisWithAnOrientationOfNone);
            }
        }
                ...
                if (this.Orientation == AxisOrientation.Y)
                {
                    ...
                    if (this.Location == AxisLocation.Left || this.Location == AxisLocation.Right)
                    {
                        ...
                        if (this.Location == AxisLocation.Right)
                        {
                            ...
                            composite.ScaleX = -1;
                            AxisGrid.RenderTransform = composite;
