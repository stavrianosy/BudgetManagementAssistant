    ...
    public abstract class RangeAxis : DisplayAxis, IRangeAxis, IValueMarginConsumer
    {
        ...
        protected IComparable ProtectedMaximum
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(ModernUI.Toolkit.Data.Charting.Resources.RangeAxis_MaximumValueMustBeLargerThanOrEqualToMinimumValue);
                }
        ...
        protected IComparable ProtectedMinimum
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(ModernUI.Toolkit.Data.Charting.Resources.RangeAxis_MinimumValueMustBeLargerThanOrEqualToMaximumValue);
                }
