        ...
        where T : IComparable
    {
        ...
        public T Maximum
        {
            get
            {
                if (!HasData)
                {
                    throw new InvalidOperationException(ModernUI.Toolkit.Data.Charting.Resources.Range_get_Maximum_CannotReadTheMaximumOfAnEmptyRange);
                }
                return _maximum;
            }
        }
        ...
        public T Minimum
        {
            get
            {
                if (!HasData)
                {
                    throw new InvalidOperationException(ModernUI.Toolkit.Data.Charting.Resources.Range_get_Minimum_CannotReadTheMinimumOfAnEmptyRange);
                }
                return _minimum;
            }
        }
        ...
        public Range(T minimum, T maximum)
        {
            ...
            if (compareValue == 1)
            {
                throw new InvalidOperationException(ModernUI.Toolkit.Data.Charting.Resources.Range_ctor_MaximumValueMustBeLargerThanOrEqualToMinimumValue);
            }
        }
        ...
        public override string ToString()
        {
            if (!this.HasData)
            {
                return ModernUI.Toolkit.Data.Charting.Resources.Range_ToString_NoData;
            }
            else
            {
                return string.Format(CultureInfo.CurrentCulture, ModernUI.Toolkit.Data.Charting.Resources.Range_ToString_Data, this.Minimum, this.Maximum);
            }
        }
    }
}
