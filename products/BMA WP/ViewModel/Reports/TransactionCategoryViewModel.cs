...
namespace BMA_WP.ViewModel.ReportsView
{
    ...
    /// </para>
    /// </summary>
    public class TransactionCategoryViewModel : ViewModelBase
    {
        #region Private Members
        private ObservableCollection<KeyValuePair<Category, double>> reportResult;
        ...
        /// <summary>
        /// Initializes a new instance of the TransactionCategoryViewModel class.
        /// </summary>
