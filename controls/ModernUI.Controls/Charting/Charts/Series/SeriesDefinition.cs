    ...
    public class SeriesDefinition : FrameworkElement, ISeries, IRequireGlobalSeriesIndex
    {
        ...
        ISeriesHost IRequireSeriesHost.SeriesHost
        {
            ...
            set
            {
                ...
                {
                    throw new NotSupportedException(ModernUI.Toolkit.Data.Charting.Resources.SeriesDefinition_SeriesHost_InvalidParent);
                }
        ...
        void IRequireGlobalSeriesIndex.GlobalSeriesIndexChanged(int? globalIndex)
        {
            ...
            {
                //AutomaticTitle = string.Format(CultureInfo.CurrentCulture, ModernUI.Toolkit.Data.Charting.Resources.Series_OnGlobalSeriesIndexPropertyChanged_UntitledSeriesFormatString, globalIndex + 1);
            }
        }
