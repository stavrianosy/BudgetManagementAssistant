...
namespace ModernUI.Toolkit.Data.Charting.Charts.Series
{
    ...
    public class BubbleSeries : DataPointSingleSeriesWithAxes
    {
        ...
        private void BubbleDataPointActualSizePropertyChanged(object sender, double oldValue,double newValue)
        {
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">Information about the event.</param>
        private void BubbleDataPointSizePropertyChanged(object sender, double oldValue, double newValue)
        {
