...
namespace ModernUI.Toolkit.Data.Charting.Charts.Axis
{
    ...
    {
        public event EventHandler<AxisLocation> LocationChanged;
        public event EventHandler<AxisOrientation> OrintationChanged;
        ...
        private static void OnLocationPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (source.LocationChanged != null)
            {
                source.LocationChanged(source, (AxisLocation)e.NewValue);
            }
        }
        ...
        private static void OnOrientationPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (source.OrintationChanged != null)
            {
                source.OrintationChanged(source, (AxisOrientation)e.NewValue);
            }
        }
