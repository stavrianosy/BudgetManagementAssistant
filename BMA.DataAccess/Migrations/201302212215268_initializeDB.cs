namespace BMA.DataAccess.Migrations
{
    ...
    public partial class initializeDB : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Target", new[] { "CreatedUser_UserId" });
            DropIndex("dbo.Target", new[] { "ModifiedUser_UserId" });
            ...
            DropForeignKey("dbo.Target", "CreatedUser_UserId", "dbo.User");
            DropForeignKey("dbo.Target", "ModifiedUser_UserId", "dbo.User");
