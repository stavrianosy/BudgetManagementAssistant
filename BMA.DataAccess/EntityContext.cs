...
namespace BMA.DataAccess
{
    public class EntityContext:DbContext, IDisposable
    {
        ...
        public DbSet<PeriodicInOut> PeriodicInOut { get; set; }
        public DbSet<TypePeriodicInOut> TypePeriodicInOut { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<PeriodicInOut>().HasRequired(c => c.CreatedUser).WithMany().WillCascadeOnDelete(false);
            //modelBuilder.Entity<PeriodicInOut>().HasRequired(c => c.ModifiedUser).WithMany().WillCascadeOnDelete(false);
