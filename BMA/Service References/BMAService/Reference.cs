...
namespace BMA.BMAService {
    ...
    public interface IMain {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMain/test", ReplyAction="http://tempuri.org/IMain/testResponse")]
        System.Threading.Tasks.Task<BMA.BusinessLogic.TypeExpense> testAsync();
    }
    ...
    public partial class MainClient : System.ServiceModel.ClientBase<BMA.BMAService.IMain>, BMA.BMAService.IMain {
        ...
        public System.Threading.Tasks.Task<BMA.BusinessLogic.TypeExpense> testAsync() {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration) {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IMain)) {
                return new System.ServiceModel.EndpointAddress("http://localhost/BMAService/BMAService.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
