...
namespace BMA.Pages.AdminPage
{
    ...
    /// </summary>
    public sealed partial class TypePeriodicInOutItemsPage : BMA.Common.LayoutAwarePage
    {
        public TypePeriodicInOutItemsPage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            TypePeriodicInOutDetailFrame.Navigate(typeof(TypePeriodicInOutDetailFrame));

            //DefaultViewModel["TypePeriodicInOuts"] = App.Instance.TransDataSource.TypePeriodicInOutList;

            //itemsViewSource.Source = App.Instance.TransDataSource.TypePeriodicInOutList;

            itemGridView.ItemsSource = itemsViewSource.Source;
        }

        private void DisplayData(TypePeriodicInOut typePeriodicInOut)
        {
            EnableAppBarStatus(true);
            // Navigate to the appropriate destination page, configuring the new page
            // by passing required information as a navigation parameter
            TypePeriodicInOutDetailFrame.Navigate(typeof(TypePeriodicInOutDetailFrame), typePeriodicInOut);
        }
