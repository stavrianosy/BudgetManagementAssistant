...
namespace BMA.Pages.AdminPage
{
    ...
    /// </summary>
    public sealed partial class TypeIntervalItemsPage : BMA.Common.LayoutAwarePage
    {
        public TypeIntervalItemsPage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            IntervalDetailFrame.Navigate(typeof(IntervalDetailFrame));

            //DefaultViewModel["Intervals"] = App.Instance.TransDataSource.IntervalList;

            //itemsViewSource.Source = App.Instance.TransDataSource.IntervalList;

            itemGridView.ItemsSource = itemsViewSource.Source;
        }

        private void DisplayData(TypeInterval typePeriodicInOut)
        {
            EnableAppBarStatus(true);
            // Navigate to the appropriate destination page, configuring the new page
            // by passing required information as a navigation parameter
            IntervalDetailFrame.Navigate(typeof(IntervalDetailFrame), typePeriodicInOut);
        }
