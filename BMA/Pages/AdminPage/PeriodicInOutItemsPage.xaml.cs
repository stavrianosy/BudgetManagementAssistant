...
namespace BMA.Pages.AdminPage
{
    ...
    /// </summary>
    public sealed partial class PeriodicInOutItemsPage : BMA.Common.LayoutAwarePage
    {
        public PeriodicInOutItemsPage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            PeriodicInOutDetailFrame.Navigate(typeof(PeriodicInOutDetailFrame));
        ...
        private void DisplayData(PeriodicInOut periodicInOut)
        {
            EnableAppBarStatus(true);
            // Navigate to the appropriate destination page, configuring the new page
            // by passing required information as a navigation parameter
            PeriodicInOutDetailFrame.Navigate(typeof(PeriodicInOutDetailFrame), periodicInOut);
        }
